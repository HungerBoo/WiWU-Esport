...
export const games = {
  league: {
    ...
    description: 'Die Wieländer-Wühlmäuse stehen für taktische Exzellenz, eiserne Disziplin und die unerschütterliche Überzeugung, dass der nächste Invade diesmal wirklich funktioniert. Mit international nicht bestätigter Erfahrung und einer strategischen Flexibilität, die selbst Riot Games gelegentlich überfordert, kämpfen sich die Wühlmäuse durch die Prime League, notfalls auch durch die eigene Jungle-Hälfte. TrulixX verkörpert dabei die philosophische Grundlage des Teams: Leben ist Leiden. Ob verlorene Lane, fehlender Gank oder ein 0/7-Teammate nach zehn Minuten. Er nimmt das Schicksal hin und spielt weiter. Nicht weil es Hoffnung gibt, sondern weil ein Surrender-Vote erst später möglich ist. HungerBoo folgt einem deutlich martialischeren Credo: Nur Eisen schärft Eisen. Entsprechend wird jede Niederlage als Training betrachtet, jede Diskussion als Verbesserungspotenzial und jeder verlorene Fight als weitere Möglichkeit, noch härter zu werden. Mental vermutlich bereits aus Kruppstahl. 1Overninja1 beweist regelmäßig, dass eine funktionierende Map nicht zwingend bedeutet, dass man sie auch vollständig nutzen muss. 404 - aber Hauptsache, Mitte wird belagert. Während andere Spieler Objectives kontrollieren, verfolgt er das eine Ziel, das wirklich zählt: Die Midlane darf unter keinen Umständen unbeaufsichtigt bleiben. Zwuck lebt nach einer einfachen, aber gefährlichen Philosophie: Ein Invade geht noch, ewig golden. Wo andere Jungler Wahrscheinlichkeiten berechnen, sieht er Chancen. Wo keine Chance mehr besteht, sieht er einen weiteren Invade. Die gegnerische Jungle-Hälfte ist schließlich auch nur eine etwas schlechter beleuchtete Erweiterung der eigenen. Falafl komplettiert die Mannschaft mit einer Rollenflexibilität, die statistisch nur schwer zu erfassen ist. Mehr Roleswaps als Caps Haare und mindestens genauso unvorhersehbar. Wo gerade eine Position frei wird, ist Falafl bereits auf dem Weg dorthin. Gemeinsam bilden die Wieländer-Wühlmäuse eine Einheit, die sich weder von Niederlagen, schlechten Drafts noch von den fundamentalen Gesetzen des Spiels aufhalten lässt. Das Ziel ist klar: Prime-League-Dominanz. Der Weg dorthin hingegen wird wahrscheinlich noch mindestens einmal invaded..',
